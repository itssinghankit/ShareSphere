...
class UsernameRepository @Inject constructor(private val retrofitInterface: RetrofitInterface) {
    private val _usernameResponseFlow =
        MutableStateFlow<ApiResponse<CheckUsernameResponse>>(ApiResponse.Initial())
    val usernameResponseFlow: MutableStateFlow<ApiResponse<CheckUsernameResponse>>
